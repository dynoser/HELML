...
/*
 * This code represents a PHP implementation of the {{class_name}} class without dependencies.
 * 
 * The class provides functions for {{forwhat}} HELML-formated data.
 * 
 */
###^ encoder decoder
###
...
###  :sections:
###   ::*: HELML.php
###   ::decoder: HELMLdecoder.php
###   ::encoder:  N
###
###  :replaces:
###   ::class_name:
###    :::encoder: HELMLencoder
###    :::decoder: HELMLdecoder
###    :::*: HELML
###   ::forwhat:
