...
что "ключи" предполагаются числовыми то 0 и выше, и поэтому их явно не указывают.

В формате HELML ключи всегда указываюся явно.

Однако, HELML позволяет отличать списки вида `[...]` от массивов вида `{...}`.
...
Этих возможностей более чем достаточно для создания транспортабельных данных 
...
и затем раскодировать их с сохранением основных типов данных (true, false, null, integer)
