...
function showOneLevelDecor(editor: vscode.TextEditor, is_list: boolean | undefined) {
...
export function edit_block_lookup(fromLineNumber: number) {
    ...
    if (isHELML) {
        showOneLevelDecor(editor, upKeyLineHELML?.is_list);
